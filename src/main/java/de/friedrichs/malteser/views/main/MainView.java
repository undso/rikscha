package de.friedrichs.malteser.views.main;
...
import de.friedrichs.malteser.views.fahrt.FahrtView;
...
public class MainView extends AppLayout {
    ...
    private static final long serialVersionUID = 8260578181319769372L;
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logos/malteser-wappen.png", "Malteser Logo"));
        logoLayout.add(new H1("Malteser Rikscha"));
...
//            new RouterLink("Fahrgäste", FahrgastView.class),
//            new RouterLink("Piloten", PilotView.class),
            new RouterLink("Bevorstehende Fahrten", FahrtView.class)
        };
